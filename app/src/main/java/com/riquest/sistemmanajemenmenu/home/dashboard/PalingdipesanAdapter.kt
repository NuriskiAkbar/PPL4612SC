...
class PalingdipesanAdapter(private var data: List<Food>,
                           private val listener:(Food) -> Unit) : RecyclerView.Adapter<PalingdipesanAdapter.ViewHolder>() {

    lateinit var contextAdapter : Context
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PalingdipesanAdapter.ViewHolder {
       val layoutInflater = LayoutInflater.from(parent.context)
        contextAdapter = parent.context
        val inflatedView = layoutInflater.inflate(R.layout.row_item_palingdipesan, parent, false)
        return ViewHolder(inflatedView)
    }

    override fun onBindViewHolder(holder: PalingdipesanAdapter.ViewHolder, position: Int) {
